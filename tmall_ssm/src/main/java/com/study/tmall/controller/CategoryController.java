...
import com.study.tmall.util.UploadedImageFile;
...
public class CategoryController {
    ...
    public String add(Category c, HttpServletRequest request, UploadedImageFile uploadedImageFile) throws IOException {
